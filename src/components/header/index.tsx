...
const data: Array<ITEM> = [{ id: 1, name: '小米商城', path: '/'}, { id: 2, name: '小米商城', path: '/'}, { id: 3, name: '小米商城', path: '/'}];
const userData: Array<ITEM> = [{ id: 1, name: '登录', path: '/'}, { id: 2, name: '注册', path: '/'}, { id: 3, name: '消息通知', path: '/'}];
